...
class Project {
    ...
    async getAllForPlanningPage() {
        const projects = await ProjectMapping.findAll({
            attributes: [
                'id', 'name', 'number', 'agreement_date', 'date_finish', 'finish',
                'design_period', 'design_start', 'designer', 'designerId',
                'project_delivery', 'date_inspection', 'inspection_designer', 'price', 'note'
            ],
        });
    ...
    async getAllProjectForComplaint() {
        const projects = await ProjectMapping.findAll({
    ...
    async getAllActiveProjectForCreatedAndUpdated() {
        const projects = await ProjectMapping.findAll({
            where: {
                date_finish: null,
                finish: null
            },
            attributes: ['id', 'name', 'number', 'regionId', 'agreement_date'],
        });
