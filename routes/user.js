...
router.get('/getOneAccountByToken/:token', UserController.getOneAccountByToken);
...
router.put('/generationUrlForClientAccount/:id([0-9]+)', UserController.generationUrlForClientAccount)
