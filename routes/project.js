...
router.get('/getAllPortfolioProjects', ProjectController.getAllPortfolioProjects)
...
router.get('/getAllStatSignedProject', ProjectController.getAllStatSignedProject)
...
router.get('/getAllWithNoWarehouseOrder', ProjectController.getAllWithNoWarehouseOrder)
router.get('/getAllProjectsWithNoInBrigadesDate', ProjectController.getAllProjectsWithNoInBrigadesDate)
router.get('/getAllProjectsWithNoInControlTour', ProjectController.getAllProjectsWithNoInControlTour)
router.get('/getone/:id([0-9]+)', ProjectController.getOne)
router.get('/getOnePortfolioProject/:id([0-9]+)', ProjectController.getOnePortfolioProject)
...
router.put('/createPriceProject/:id([0-9]+)', ProjectController.createPriceProject)
...
router.put('/updateDesigner/:id([0-9]+)', ProjectController.updateDesigner)
router.put('/createLogisticProject/:id([0-9]+)', ProjectController.createLogisticProject)
router.put('/reviseProjectNameAndNumber/:id([0-9]+)',  ProjectController.reviseProjectNameAndNumber)
