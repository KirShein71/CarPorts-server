...
class ProjectController {
    ...
    async getAllActiveWithDateFinishProject(req, res, next) {
        try {
            const project = await ProjectModel.getAllActiveWithDateFinishProject()
            res.json(project)
        } catch(e) {
            next(AppError.badRequest(e.message))
        }
    ...
    async getAllStatProject(req, res, next) {
        try {
            const project = await ProjectModel.getAllStatProject()
            res.json(project)
        } catch(e) {
            next(AppError.badRequest(e.message))
        }
   ...
   async create(req, res, next) {
    ...
    async updateDesigner(req, res, next) {
        try {
            ...
            const project = await ProjectModel.updateDesigner(req.params.id, req.body,)
            res.json(project)
        } catch(e) {
            next(AppError.badRequest(e.message))
        }
    ...
    async updateDesignStart(req, res, next) {
        try {
            if (!req.params.id) {
                throw new Error('Не указан id товара')
            }
            ...
            const project = await ProjectModel.updateDesignStart(req.params.id, req.body,)
            res.json(project)
        } catch(e) {
            next(AppError.badRequest(e.message))
        }
    ...
    async updateProjectDelivery(req, res, next) {
        try {
            if (!req.params.id) {
                throw new Error('Не указан id товара')
            }
            ...
            const project = await ProjectModel.updateProjectDelivery(req.params.id, req.body,)
            res.json(project)
        } catch(e) {
            next(AppError.badRequest(e.message))
        }
    ...
    async updateDateInspection(req, res, next) {
        try {
            if (!req.params.id) {
                throw new Error('Не указан id товара')
            }
            ...
            const project = await ProjectModel.updateDateInspection(req.params.id, req.body,)
            res.json(project)
        } catch(e) {
            next(AppError.badRequest(e.message))
        }
